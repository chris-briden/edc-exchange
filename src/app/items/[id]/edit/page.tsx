        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {listingType === "rent" && (
            <div className="space-y-4">
              ...
              <div>
                <label htmlFor="rentalDeposit" className="block text-sm font-medium text-gray-700 mb-1">
                  Security Deposit ($)
                </label>
                <input
                  id="rentalDeposit"
          ...
          {showShipping && (
            <div className="space-y-4 p-4 bg-gray-50 rounded-xl">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="shipsFrom" className="block text-sm font-medium text-gray-700 mb-1">
                    Ships From
                  </label>
                  <input
                    id="shipsFrom"
                ...
                <div className="flex items-end pb-1">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      className="w-4 h-4 rounded border-gray-300 text-orange-600 focus:ring-orange-500"
                    />
                    <span className="text-sm text-gray-700">Accepts Returns</span>
                  </label>
                </div>
              </div>
            </div>
