  ...
  useEffect(() => {
    ...
    const fetchOrder = async () => {
      try {
        ...
        // If no transaction yet (webhook still processing), retry up to 5 times
        if (!data.transaction && retryCount < 5) {
            ...
            <div className="p-6 border-b border-zinc-800">
              <div className="flex gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {listing?.brand && (
                    <p className="text-sm text-gray-400">{listing.brand}</p>
                  )}
                  <div className="flex items-center gap-2 mt-1">
                    <span className="text-xs px-2 py-0.5 rounded-full bg-zinc-800 text-gray-300 capitalize">
              ...
              <div className="space-y-2 text-sm">
                ...
                {shipment && (
                  <div className="flex justify-between text-gray-300">
                    ...
                    <span>
                      ${parseFloat(shipment.buyer_rate).toFixed(2)} CAD
                    </span>
                  </div>
                )}
                {transaction && (
                ...
                {!transaction && listing && (
                  <div className="flex justify-between font-bold pt-2 border-t border-zinc-700 text-white">
                    ...
                    <span className="text-green-400">
                      ${parseFloat(listing.price || "0").toFixed(2)} CAD
                    </span>
                  </div>
                )}
              </div>
            ...
            {shipment && (
              <div className="p-6 border-b border-zinc-800">
                ...
                <div className="space-y-3">
                  ...
                  {/* Download label (for seller — but show status to buyer) */}
                  {shipment.label_url && (
                    <div className="p-3 rounded-xl bg-zinc-800 text-sm text-gray-400">
                      <div className="flex items-center gap-2">
                        <Download className="w-4 h-4 shrink-0" />
                        <span>
                          A shipping label has been generated. The seller will
                          ship your item soon.
                        </span>
                      </div>
                    </div>
            ...
            <div className="p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-green-900/50 flex items-center justify-center shrink-0 mt-0.5">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-gray-500">
                      {shipment
                        ? "A shipping label has been created automatically"
                        : "The seller will arrange shipping"}
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-gray-500">
                      {isRental
                        ? "A prepaid return label will be included"
