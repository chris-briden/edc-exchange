  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        <h1 className="text-3xl font-extrabold mb-6">About EDC Exchange</h1>
        <div className="prose prose-gray max-w-none space-y-4 text-gray-600">
          ...
          <h2 className="text-xl font-bold text-gray-900 pt-4">What makes us different</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 pt-4">Community first</h2>
          <p>
