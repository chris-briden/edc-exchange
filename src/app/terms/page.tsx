    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="prose prose-gray max-w-none space-y-4 text-gray-600">
          ...
          <h2 className="text-xl font-bold text-gray-900 pt-4">1. Acceptance of Terms</h2>
          <p>
            By creating an account or using EDC Exchange, you agree to these terms. If you do not
            agree, please do not use the platform.
          </p>
          <h2 className="text-xl font-bold text-gray-900 pt-4">2. User Accounts</h2>
          <p>
            You are responsible for maintaining the confidentiality of your account credentials and
            for all activities that occur under your account. You must provide accurate information
            when creating your account.
          </p>
          <h2 className="text-xl font-bold text-gray-900 pt-4">3. Marketplace Conduct</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 pt-4">4. Community Guidelines</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 pt-4">5. Limitation of Liability</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 pt-4">6. Changes to Terms</h2>
          <p>
