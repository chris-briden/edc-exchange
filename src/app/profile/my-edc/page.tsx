                ...
                {userItems.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-xs font-medium text-gray-700 p-2 text-center line-clamp-1">
                        {item.name}
                      </p>
                      {isSelected && (
            ...
            <div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-orange-50 rounded-2xl p-4 border border-blue-100">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p className="font-semibold text-sm">{name || "My EDC"}</p>
                </div>
                <div className="grid grid-cols-4 sm:grid-cols-6 gap-2">
                  {selectedItemIds.map((id) => {
                    ...
                    return (
                      <div key={id}>
                        <div className="aspect-square rounded-lg bg-white border border-gray-200 overflow-hidden shadow-sm">
                          {firstImage ? (
                            <Image
                              src={firstImage}
                              alt={item.name}
