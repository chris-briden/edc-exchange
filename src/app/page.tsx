    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 py-20 text-center">
          ...
          {/* Subheadline - the marketplace tagline */}
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
            The marketplace for{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-blue-400 font-semibold">
              everyday carry
            </span>{' '}
            enthusiasts. Buy, sell, trade, and{' '}
            <span className="text-orange-400 font-semibold">rent</span> the gear you carry every day.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-6">
            <Link
              href="/signup"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-orange-700 text-white text-lg font-semibold hover:bg-orange-600 transition shadow-lg shadow-orange-900/50"
            >
              Create Account <ArrowRight className="w-5 h-5" />
            </Link>
            <Link
              href="/marketplace"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-zinc-800/80 text-white text-lg font-semibold hover:border-orange-500/50 hover:bg-zinc-700/80 transition border border-zinc-600"
            >
              Browse Marketplace
            </Link>
          </div>
          ...
          <p className="text-sm text-gray-500">
            Free to join. Start listing in minutes.
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative bg-gradient-to-br from-zinc-900 to-black border border-orange-500/30 rounded-2xl p-12 overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
                Create your free account and start listing your EDC gear today.
                Knives, pens, watches, flashlights, multi-tools, and more.
              </p>
