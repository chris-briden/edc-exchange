...
- **A purpose-built rucksack** (GORUCK, Mystery Ranch, 5.11) — these are designed to carry weight comfortably with reinforced frames and proper weight distribution
- **Ruck plates** — flat weights that sit flush against your back, much more comfortable than loose weights
- **A weighted vest** — some people prefer this for shorter, faster rucks
